...
def main():
    ...
    df, df_conc = run_across_init_largegamma(gtm=gtm, save_dir_full = save_dir_full, save_dir_conc = save_dir_concise, num_startprofiles=args.num_startprofiles, T=args.horizon, eta = args.eta)
